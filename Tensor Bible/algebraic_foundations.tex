...
The set of functions $V^{X}$ mapping from an arbitrary set $X$ to a vector space $V$ over $\mathbb{F}$ can be turned into a vector space over $\mathbb{F}$ with the following operations defined pointwise.
